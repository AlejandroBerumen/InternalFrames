...
class Ventana extends JFrame{
	JMenuBar menuBar;
	JMenu masters, booking, testPerform, printing, transaction, labReport, setings, window, help;
	JMenuItem menuItem;
	JToolBar barraH;
	...
	public Ventana() {
		...
		labReport = new JMenu("Lab Reports");
		setings = new JMenu("Settings");
		window = new JMenu("Window");
		help = new JMenu("Help");
		menuItem = new JMenuItem("Lab Master");
		...
		String []z = {"MALE","FEMALE"}; 
		JComboBox<String> s = new JComboBox<String>(z);
		JLabel age = new JLabel("Age");
		JLabel monts = new JLabel("  Mons");
		JLabel days = new JLabel("  Days");
		JLabel sample = new JLabel("     Sample By");
		...
		panel1.add(sampleT);
		panel1.add(zero3);
		JLabel referente = new JLabel("Refered By:");
		JTextField referenteT = new JTextField(5);
		JTextField solovino = new JTextField(15);
		JLabel panelCode = new JLabel("  Panel Code");
		...
		panel1.add(panelT);
		panel1.add(zero4);
		JLabel panelID = new JLabel("                                                                                                                                   Panel ID");
		...
		String cabezaT []={"Test ID", "Test Name","Rate","Disc %","Discount Amount","Tax(%)","Tax Amt"};
		...
		formulario.add(header);
		formulario.add(tabla);
		JLabel totalTest = new JLabel("Total Tests");
		JLabel testAmount = new JLabel("Test Amt.");
		JLabel consension = new JLabel("Concenssion");
		JLabel homecolector = new JLabel("Home Colection");
		JLabel taxAmount = new JLabel("Tax Amt");
		JLabel netAmount = new JLabel("Net Amt");
		...
		panel3.setBounds(1, 480, 873, 60);
		panel3.setBackground(Color.WHITE);
		panel3.setLayout(null);
		JLabel homec = new JLabel("Home Colection");
		JLabel paid = new JLabel("Paid");
		JLabel typePaid = new JLabel("Pay Type");
		JLabel receibNo = new JLabel("Receipt No.");
		String[] t = {"CASH", "CREDIT CARD"};
		...
		panel4.setBounds(1, 540, 870, 65);
		JLabel instrucciones1 = new JLabel("F1: Select Test  F2: Save Entry  F3: Perform Test  F4: New Booking  F5: Payment Type  F6: Delete Entry  F7: Conc.  F8: Add Row                                             ");
		instrucciones1.setForeground(Color.WHITE);
		JLabel instrucciones2 = new JLabel("F9: Tests Selected  F11: Print Recipt  F12: Patient Details  Ctrl+F7: Payment Mode  Ctrl+F2: Show Concession   Time in 24 Hours                                             ");
		instrucciones2.setForeground(Color.WHITE);
		JLabel instrucciones3 = new JLabel("Format (Click on Time Label for more Information)   Value in this field is coming from the Masters");
		instrucciones3.setForeground(Color.WHITE);
		panel4.add(instrucciones1);
		panel4.add(instrucciones2);
		panel4.add(instrucciones3);
		formulario.add(panel1);
		formulario.add(panel2);
		formulario.add(panel3);
		formulario.add(panel4);
		dp.add(formulario);
